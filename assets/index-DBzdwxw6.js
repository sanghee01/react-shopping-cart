...
function OrderPriceSummary({ couponPriceItem }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(OrderPriceSummaryContainer, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(InfoLabel, { description: "총 주문 금액이 100,000원 이상일 경우 무료 배송됩니다." }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CalaculateList, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(OrderPriceItem, { title: "주문 금액", price: totalPrice }),
      couponPriceItem && /* @__PURE__ */ jsxRuntimeExports.jsx(OrderPriceItem, { title: "쿠폰 할인 금액", price: couponDiscountPrice }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(OrderPriceItem, { title: "배송비", price: deliveryFee, "data-testid": "delivery-fee" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(OrderPriceItem, { title: "총 결제 금액", price: totalPurchasePrice, "data-testid": "total-purchase-price" })
  ] });
}
function OrderConfirmationText() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "최종 결제 금액을 확인해 주세요." })
  ] });
}
...
function OrderSuccessPage() {
  ...
  return /* @__PURE__ */ jsxs(OrderSuccessContainer, { children: [
    ...
    /* @__PURE__ */ jsxs(OrderSuccessSection, { children: [
      /* @__PURE__ */ jsx2(OrderSuccessTitle, { children: "결제 확인" }),
      ...
      /* @__PURE__ */ jsx2(OrderSuccessQuantity, { children: "최종 결제 금액을 확인해 주세요." }),
      /* @__PURE__ */ jsx2(OrderSuccessTotalPurchasePriceLabel, { children: "총 결제 금액" }),
...
const CouponModal = ({ isOpen, onClose }) => {
  ...
  return /* @__PURE__ */ jsxs(O, { isOpen, onClose, position: "center", size: "medium", children: [
    /* @__PURE__ */ jsx2(O.Header, { title: "쿠폰을 선택해 주세요", showCloseButton: true }),
    /* @__PURE__ */ jsxs(O.Content, { children: [
      /* @__PURE__ */ jsx2(InfoLabel, { description: "쿠폰은 최대 2개까지 사용할 수 있습니다." }),
